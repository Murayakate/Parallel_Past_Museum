          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <span className="text-[8rem] md:text-[10rem] font-bold text-white/5 font-heading leading-none">
                  {step.number}
                </span>
              </div>
              ...
              <div className="relative z-10">
                <h3 className="font-heading text-2xl md:text-3xl text-white font-bold mb-4 tracking-tight">
                  {step.title}
                </h3>
